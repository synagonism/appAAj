/*
 * version: 2010.08.31
 * HtmlMapFolioViews.java - Maps a preprocessed-FolioViews to html-sfi.
...
public class HtmlMapFolioViews
{
	...
	public static void main(String args[])
	{
		if (args.length!=1) {
			...
			System.out.println("java pk_Html.HtmlMapFolioViews <g:/file1/.../folio.html>");
		}
		else
			new HtmlMapFolioViews(args[0]);
	}
