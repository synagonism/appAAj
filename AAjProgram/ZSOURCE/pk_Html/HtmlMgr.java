...
//****************************************************************
	...
	public static void main(String args[])
	{
		if (args.length== 0)
			...
			System.out.println("java pk_Html.HtmlMgr");
			System.out.println("or");
			System.out.println("java pk_Html.HtmlMgr <path of whatToDisplay>");
		}
	}
...
//			return null;
	 ...
	 * @modified 2010.08.21
	 * @since 2010.08.21 (v00.02.03)
	 * @author https://sourceforge.net/projects/browserlaunch2/
	 */
	...
	class ActionFileNew extends HtmlMgrAction
	{
		...
		public void actionPerformed(ActionEvent evt) {
			String sHtml=
					...
					+"\n<hr/>"
					+"\n<p class=\"last\">"
					+"\n  This is an <a href=\"https://htmlmgr.sourceforge.net/index.html#ifiSFI\">SFI-file</a>, best viewed with <a href=\"https://htmlmgr.sourceforge.net/\">HtmlMgr</a>."
					+"\n  <a class=\"hide\">#h0.toc#</a>"
					+"\n</p>"
					+"\n<p class=\"last\">"
					+"\n  VERSIONS:"
	...
	class ActionFileOpenUrl extends HtmlMgrAction
	{
		...
		public void actionPerformed(ActionEvent evt) {
			String sInput = JOptionPane.showInputDialog(
				...
				"https://htmlmgr.sourceforge.net/index.html"); //initial
			if(sInput != null) {
...
*/
	...
	/**
	 * Goes to Home-directory (https://htmlmgr.sourceforge.net/).
	 *
	 * @modified 2010.08.22
	 * @since 2010.04.30 (v00.02.02)
	 * @author HoKoNoUmo
	...
	class ActionGotoHome extends HtmlMgrAction
	{
		...
		public void actionPerformed(ActionEvent evt) {
			cJLbStatus.setText("... https://htmlmgr.sourceforge.net/");
			displayUrl("https://htmlmgr.sourceforge.net/", true);
		}
	}
