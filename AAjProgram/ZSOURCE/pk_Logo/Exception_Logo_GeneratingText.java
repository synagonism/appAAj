/*
 * Exception_Logo_GeneratingText.java - Exception which is thrown
 * when an error occures while generating AAj-Text.
 ...
 * while generating AAj-Text.
 * @modified 2004.07.24
 * @since 2004.06.14 (v00.02.00)
 * @author HoKoNoUmo
 */
public class Exception_Logo_GeneratingText
	extends RuntimeException
{
	 ...
	 */
	public Exception_Logo_GeneratingText(String message)
	{
		super(message);
