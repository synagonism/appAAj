 ...
 *
 * IF current is an OBJECT THEN the existing must be a RELATION of current-lg_object to another-lg_object.
 * It inserts in current, the existing as environment.
 * It inserts in existing, the current as environment IF it is not.
 *
 * IF current is a RELATION THEN the existing must be an lg_object of this corelaton.
 *
 ...
 * @author HoKoNoUmo
 */
public class FrameAddAttEnvironment extends JFrame
{
	...
	public FrameAddAttEnvironment(String acpt)
	{
